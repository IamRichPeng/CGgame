...
public class EventCenter
{
    ...
    private static void OnListenerAdding(EventDefine eventType, Delegate callBack)
    {
        ...
        {
            throw new Exception(string.Format("try to add different kinds of commmision to Event(0), current commision is (1), need to add commision (2).", eventType, d.GetType(), callBack.GetType()));
        }
    }
